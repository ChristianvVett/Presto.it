    <div class="col-12 col-lg-6 col-xl-5 align-self-center">
        ...
        <form class="p-5 my-3 form2"  wire:submit.prevent='store' enctype="multipart/form-data">

            @csrf

            <div class="mb-3">
                <label for="exampleInputTitle" class="form-label" >{{__('ui.live_titolo')}} <i class="bi bi-search"></i></label>
                <input type="text"  class="form-control @error('title') is-invalid @enderror"  aria-describedby="TitleHelp" placeholder="{{__('ui.live_nome_annuncio')}}" value="{{old('title')}}"  wire:model='title'>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('price') is-invalid @enderror"  aria-describedby="priceHelp" placeholder="{{__('ui.live_prezzo_annuncio')}}" value="{{old('price')}}" wire:model='price'>
               {{-- visualizzazione errori real-time --}}
            ...
            <div class="mb-3">
                ...
                <textarea type="longtext" class="form-control @error('description') is-invalid @enderror" rows="10" placeholder="{{__('ui.live_descrizione_annuncio')}}" wire:model='description'>{{old('description')}}</textarea>
                {{-- visualizzazione errori real-time --}}
